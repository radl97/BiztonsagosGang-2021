...
private val appSettingsRepository: AppSettingsRepository
    ...
    override suspend fun uploadCaff(name: String, uri: Uri) {
        uri.path?.let{File(it)}?.let{ file ->

            // create RequestBody instance from file
            val requestFile = file.asRequestBody("".toMediaType()) //todo mediatype
    ...
    override suspend fun downloadCaff(caffId: Int) {
